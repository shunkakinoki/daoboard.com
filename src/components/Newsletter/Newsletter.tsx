          ...
          >
            <div className="relative flex-1 min-w-0">
              ...
              <input
                ...
                name="email"
                type="email"
                className="block py-3 px-5 w-full text-base placeholder-gray-500 text-gray-900 rounded-md border border-transparent focus:border-transparent focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-violet-600 shadow-sm focus:outline-none"
            ...
            <div className="mt-4 sm:mt-0 sm:ml-3">
              <button
                type="submit"
                className={clsx(
                  "inline-flex items-center py-3 px-5 sm:px-10 w-full text-base font-medium text-white bg-violet-500 hover:bg-violet-400 dark:bg-violet-600 dark:hover:bg-violet-500 rounded-md border border-white focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-violet-600 shadow focus:outline-none",
